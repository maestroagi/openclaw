...
type OwnedRuntimeChunk = { source: string; extensions: readonly string[] };

async function writeOwnedChunks(packageRoot: string, chunks: Record<string, OwnedRuntimeChunk>) {
