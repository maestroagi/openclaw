...
export const en: TranslationMap = {
  ...
  agentTools: {
    githubTitle: "GitHub CLI Identity",
    githubSubtitle:
    ...
    githubEffective: "Effective account",
    githubNoAccount: "No verified account",
    githubAuthor: "Git author",
    githubEvidence: "Evidence",
    githubPermissionsNotVerified: "write permissions are not remotely verified",
    githubScope: "Configure",
    githubSystem: "System identity",
    githubAgentOverride: "Agent override",
    ...
    githubConfigure: "Configure / Replace",
    githubUseSystem: "Use system/default",
    githubUseNative: "Use native identity",
    githubCloudNote:
      "Existing repository remote credentials are not overridden. Direct branch and pull request publication will be handled by a separate Gateway broker; it is not part of this identity foundation.",
